...
def load_data(file):
    ...
    df.columns = ["ticker", "buy_vol", "buy_amt", "sell_vol", "sell_amt", "volume", "oi", "transaction_date"]
    df["daily_vol"] = df["buy_vol"] - df["sell_vol"]
    df = df[["ticker", "transaction_date", "buy_vol", "buy_amt", "sell_vol", "sell_amt", "volume", "oi", "daily_vol"]]
